---
name: context-budget
description: "Use when Claude Code feels sluggish, output quality drops, or you've added many skills/agents/MCP servers — triggers on /context-budget, \"audit context\", \"why is this slow\", \"how much context do I have left\", \"shrink the context\", \"reduce token overhead\", or planning to add more components and need to know if there's room. Produces prioritized token-savings recommendations across agents, skills, MCP servers, and rules."
origin: ECC
---
