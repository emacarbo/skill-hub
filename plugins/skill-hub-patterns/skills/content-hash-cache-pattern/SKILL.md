...
description: "Use when adding caching to file-processing pipelines (PDF parsing, image analysis, text extraction) where the same files are processed repeatedly. Triggers on \"cache file results\", \"skip reprocessing\", \"--cache flag\", or any pipeline that calls an expensive function per file. NOT for caching HTTP responses or database queries."
origin: ECC
---
