---
name: skill-sync
description: "Use for periodic pipeline maintenance — triggers on /skill-sync, \"sync skills\", \"audit skills\", \"check skills\", or \"are my skills up to date\". Flags stale skills (unused 30+ days), checks GitHub upstream for updates, and detects missing symlinks. Run weekly or after adding new skills."
