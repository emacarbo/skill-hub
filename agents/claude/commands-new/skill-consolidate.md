...
description: Map relationships between promoted skills — groups, overlaps, blind spots. Output is a consolidation-map.yaml used by the agent when rewriting to agents/claude/
